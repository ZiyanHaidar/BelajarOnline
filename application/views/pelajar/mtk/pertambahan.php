...
<body class="bg-gray-100 font-sans">
            ...
            <ul class="flex py-4">
                <li class="px-4 py-2 hover:bg-gray-300 relative">
                    <a href="#"
                        ...
                        id="catalogDropdownToggle">Lihat Mata pelajaran</a>
                    <ul class="absolute hidden text-gray-700 bg-white shadow-lg py-2 mt-1 w-100 rounded-lg"
                        id="catalogDropdownMenu">
                        <li><a href="#" class="block px-4 py-2 hover:bg-gray-100" onclick="openModal()">Pilih Mata
                                Pelajaran</a>
                        </li>
                ...
                <li class="px-4 py-2 hover-bg-gray-300"><a href="#"
                    ...
                    <div class="profile-details" id="profileDropdownToggle">
                        ...
                        <ul class="absolute hidden text-gray-700 bg-white shadow-lg py-2 mt-1 w-35 rounded-lg right-0 top-full"
                            ...
                            <li><a href="#" onclick="confirmLogout()"
                                    class="block px-4 py-2 hover:bg-gray-100">Keluar</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <main class="container mx-auto mt-8">
        ...
        <section id="pertambahan" class="mb-8">
            <h2 class="text-2xl font-bold mb-4">Pertambahan</h2>

            <p class="mb-4">
                Pertambahan adalah operasi matematika untuk menambahkan dua atau lebih bilangan sehingga
                mendapatkan hasil yang disebut jumlah atau total.
            </p>

            <h3 class="text-xl font-bold mb-2">Cara Menyelesaikan Pertambahan:</h3>

            <ol class="list-decimal pl-8 mb-4">
                <li>Pilih dua atau lebih bilangan yang akan ditambahkan.</li>
                <li-Tambahkan bilangan-bilangan tersebut satu per satu.</li>
                    <li>Hasil akhir dari penambahan tersebut adalah jumlah dari semua bilangan yang ditambahkan.</li>
            </ol>

            <h3 class="text-xl font-bold mb-2">Contoh Pertambahan:</h3>

            <p>
                Misalnya, untuk menyelesaikan pertambahan 3 + 5, kita tambahkan angka 3 dengan angka 5:
            </p>
      ...
      8
            ...
            <p>
                Jadi, 3 + 5 sama dengan 8. Hasil ini adalah jumlah dari kedua bilangan tersebut.
            </p>
        </section>
