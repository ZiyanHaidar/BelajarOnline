...
<body class="bg-gray-100 font-sans">
  ...
  <main class="container mx-auto mt-8 discussion">
  ...
  <section id="perkalian" class="mb-8">
    <h2 class="text-2xl font-bold mb-4">Perkalian</h2>

    <p class="mb-4">
      Perkalian adalah operasi matematika untuk menentukan hasil dari penggandaan dua atau lebih bilangan.
    </p>

    <h3 class="text-xl font-bold mb-2">Cara Menyelesaikan Perkalian:</h3>

    <ol class="list-decimal pl-8 mb-4">
      <li>Pilih dua atau lebih bilangan yang akan dikalikan.</li>
      <li>Kalikan bilangan tersebut satu per satu, atau sebagai penjumlahan berulang.</li>
      <li>Hasil akhir dari perkalian adalah jumlah dari semua hasil perkalian.</li>
    </ol>

    <h3 class="text-xl font-bold mb-2">Contoh Perkalian (Penjumlahan Berulang):</h3>

    <p>
      Misalnya, untuk menyelesaikan perkalian 2 x 4, kita dapat melihatnya sebagai penjumlahan berulang:
    </p>
    ...
    <p>
      Jadi, 2 x 4 dapat diartikan sebagai penjumlahan berulang dari angka 2 sebanyak 4 kali, dan hasilnya adalah 8.
    </p>
  </section>
